...
<div style="width: 40%; margin: auto">
    <form action="">
        <fieldset>
            ...
            <div><input type="text" name="lastName" title="Last Name" placeholder="Last Name" required value="Donchev">
            </div>
            <div><input type="email" name="email" title="Email" placeholder="Email" required value="xmt@abv.bg"></div>
            <div><input type="text" name="phoneNumber" title="Phone Number" placeholder="Phone Number" required
                        value="+359 895 44 33 22"></div>
        ...
        <fieldset>
            ...
            <div>
                ...
                <input type="text" id="companyFrom" name="companyFrom" placeholder="dd/mm/yyyy" required
                       value="01/01/2009">
            </div>
            <div>
